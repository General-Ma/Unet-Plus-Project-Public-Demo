...
A concise public demo showcasing a 2D UNet-style segmentation project
...
- [app/elements/model_architecture/B_Unet.py](app/elements/model_architecture/B_Unet.py#L1) — example model
...
Illustrations
-------------
Below are correctness-first illustrations of the project components and expected output.
