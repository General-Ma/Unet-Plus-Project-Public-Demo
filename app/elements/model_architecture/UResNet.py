...
def u_resnet_2d(n_class=1, input_size=(200, 200, 1)):
    ...
    # add residual layer and path
    shortcut_e1 = Conv2D(16, (1, 1), activation='relu', padding='same')(e11)
    shortcut_e1 = BatchNormalization()(shortcut_e1)
    shortcut_pool1 = MaxPooling2D(pool_size=(2, 2))(shortcut_e1)
    pool1 = Add()([pool1,shortcut_pool1])
    ...
    shortcut_pool2 = MaxPooling2D(pool_size=(2, 2))(shortcut_e2)
    pool2 = Add()([pool2,shortcut_pool2])
    ...
    shortcut_pool3 = MaxPooling2D(pool_size=(2, 2))(shortcut_e3)
    pool3 = Add()([pool3,shortcut_pool3])
